...
import { getControlsState } from 'src/injections/explore/store';
...
import {
  ...
  shouldUseLegacyApi,
  getChartDataUri,
} from 'src/injections/explore/exploreUtils';
import {
  requiresQuery,
  ANNOTATION_SOURCE_TYPES,
} from 'src/features/modules/AnnotationTypes';

import { addDangerToast } from 'src/features/messageToasts/actions';
import { logEvent } from 'src/features/logger/actions';
import { Logger, LOG_ACTIONS_LOAD_CHART } from 'src/features/logger/LogUtils';
import { getClientErrorObject } from 'src/utils/getClientErrorObject';
import { allowCrossDomain as domainShardingEnabled } from 'src/utils/hostNamesConfig';
import { updateDataMask } from 'src/features/dataMask/actions';
