...
function mapStateToProps(state, props) {
  ...
  const queryEditor = sqlSupport.queryEditors.find(
    editor => editor.id === props.queryEditorId,
  );

  return { sqlSupport, ...props, queryEditor };
}
