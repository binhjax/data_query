...
import { FilterConfiguration } from 'src/injections/dashboard/components/nativeFilters/types';
import { DataMaskType, DataMaskStateWithId } from 'src/features/dataMask/types';
import {
  SET_DATA_MASK_FOR_FILTER_CONFIG_COMPLETE,
  SET_DATA_MASK_FOR_FILTER_CONFIG_FAIL,
} from 'src/features/dataMask/actions';
