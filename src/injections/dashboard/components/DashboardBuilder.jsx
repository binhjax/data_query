...
import BuilderComponentPane from 'src/injections/dashboard/components/BuilderComponentPane';
import DashboardHeader from 'src/injections/dashboard/containers/DashboardHeader';
import DashboardGrid from 'src/injections/dashboard/containers/DashboardGrid';
import IconButton from 'src/injections/dashboard/components/IconButton';
import DragDroppable from 'src/injections/dashboard/components/dnd/DragDroppable';
import DashboardComponent from 'src/injections/dashboard/containers/DashboardComponent';
import ToastPresenter from 'src/features/messageToasts/containers/ToastPresenter';
import WithPopoverMenu from 'src/injections/dashboard/components/menu/WithPopoverMenu';

import findTabIndexByComponentId from 'src/injections/dashboard/util/findTabIndexByComponentId';

import getDirectPathToTabIndex from 'src/injections/dashboard/util/getDirectPathToTabIndex';
import getLeafComponentIdFromPath from 'src/injections/dashboard/util/getLeafComponentIdFromPath';
...
class DashboardBuilder extends React.Component {
  ...
  render() {
    console.log("binhnt.injections.dashboard.componenets.DashboardBuilder.render: start ")
    const {
      handleComponentDrop,
      dashboardLayout,
      editMode,
