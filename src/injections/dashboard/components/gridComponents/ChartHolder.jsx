...
import { getChartIdsInFilterScope } from 'src/injections/dashboard/util/activeDashboardFilters';
...
class ChartHolder extends React.Component {
  ...
  render() {
    ...
    if (this.state.isFullSize) {
      ...
      if (chartWidth = document.body.clientWidth >= 600) {
    ...
    // console.log("binhnt: injections.dashboard.components.gridComponent.ChartHolder: width = ", component.meta.chartId, component.id, chartWidth, document.body.clientWidth)
      ...
      >
        {
          ({ dropIndicatorProps, dragSourceRef }) => (
            <ResizableContainer
              id={component.id}
              adjustableWidth={parentComponent.type === ROW_TYPE && document.body.clientWidth >= 600}
              adjustableHeight
