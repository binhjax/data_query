...
class DashboardGrid extends React.PureComponent {
  ...
  handleResizeStart({ ref, direction }) {
    console.log("binhnt.injections.dashboard.components.DashboardGrid.handleResizeStart")
  ...
  handleResize({ ref, direction }) {
    console.log("binhnt.injections.dashboard.components.DashboardGrid.handleResize")
  ...
  handleResizeStop({ id, widthMultiple: width, heightMultiple: height }) {
    console.log("binhnt.injections.dashboard.components.DashboardGrid.handleResizeStop")
