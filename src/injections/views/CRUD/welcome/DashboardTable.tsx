...
import { useListViewResource, useFavoriteStatus } from 'src/injections/views/CRUD/hooks';
import { Dashboard, DashboardTableProps } from 'src/injections/views/CRUD/types';
import { useHistory } from 'react-router-dom';
import withToasts from 'src/features/messageToasts/enhancers/withToasts';
import PropertiesModal from 'src/injections/dashboard/components/PropertiesModal';
import DashboardCard from 'src/injections/views/CRUD/dashboard/DashboardCard';
