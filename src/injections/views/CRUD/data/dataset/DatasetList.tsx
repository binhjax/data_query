...
import {
  ...
  createFetchDistinct,
  createErrorHandler,
} from 'src/injections/views/CRUD/utils';
import { useListViewResource } from 'src/injections/views/CRUD/hooks';
...
import { commonMenuData } from 'src/injections/views/CRUD/data/common';
