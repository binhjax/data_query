 ...
 * under the License.
 */
import getDetailedComponentWidth from 'src/injections/dashboard/util/getDetailedComponentWidth';
import * as types from 'src/injections/dashboard/util/componentTypes';
import {
  GRID_COLUMN_COUNT,
