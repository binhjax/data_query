...
import { NativeFiltersForm } from 'src/injections/dashboard/components/nativeFilters/FiltersConfigModal/types';
import FiltersConfigForm from 'src/injections/dashboard/components/nativeFilters/FiltersConfigModal/FiltersConfigForm/FiltersConfigForm';
