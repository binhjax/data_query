...
import {
  ...
  SQL_TOOLBAR_HEIGHT,
} from 'src/injections/SqlLab/constants';
import AceEditorWrapper from 'src/injections/SqlLab/components/AceEditorWrapper';
import ConnectedSouthPane from 'src/injections/SqlLab/components/SouthPane';
import SqlEditor from 'src/injections/SqlLab/components/SqlEditor';
import SqlEditorLeftBar from 'src/injections/SqlLab/components/SqlEditorLeftBar';
import { Dropdown } from 'src/common/components';
import {
  queryEditorSetFunctionNames,
  queryEditorSetSelectedText,
} from 'src/injections/SqlLab/actions/sqlLab';
